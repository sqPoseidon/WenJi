...
module.exports = function(app){
  //默认用户信息路由
  app.get('/user',loadUser,loggedIn,function(req,res,next){
  ...
  //用户查看收藏的文章的路由
  app.get('/user/coArticles',loadUser,loggedIn,function(req,res,next){
  ...
  //用户编辑个人资料路由
  app.get('/user/edit',loadUser,loggedIn,function(req,res,next){
    res.render('user/edit',{user:req.user});
  });
  //用户提交个人信息路由
  app.post('/user',loadUser,loggedIn,function(req,res,next){
    var user = req.user;
